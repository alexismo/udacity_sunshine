...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        long northPoleRowId;
        northPoleRowId = insertLocation(db, northPoleLocationContentValues);
        assertFalse("north Pole isnt -1", northPoleRowId == -1);

        // Query the database and receive a Cursor back
        Cursor npCursor = db.query(
        ...
        assertTrue("Error: No records returned from location query.",npCursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Unexpected value, not North Pole",
                npCursor, northPoleLocationContentValues);
    ...
    public void testWeatherTable() {
        ...
        // Insert ContentValues into database and get a row ID back
        db.insert(WeatherEntry.TABLE_NAME,null,weatherContentValues);
        ...
        // Move the cursor to a valid database row
        assertTrue("Error: no data was returned from the weather query",weatherCursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCursor("Weather Values dont match",weatherCursor,weatherContentValues);
